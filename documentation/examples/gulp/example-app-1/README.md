# Example App - 1 (Babelify, ESlint, Sass, Stylelint, HTMLmin) (live-alert-bp)

**1.** Download or copy [example-app-1](https://github.com/semiromid/live-alert-bp/tree/master/documentation/examples/gulp/example-app-1)
