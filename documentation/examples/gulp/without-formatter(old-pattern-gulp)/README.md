...
**1.** Download or copy [example-without-using-formatter(old-pattern-gulp)](https://github.com/semiromid/live-alert-bp/tree/master/documentation/examples/gulp/without-formatter(old-pattern-gulp))
