# Example - 1 with using the JS and ESlint (live-alert-bp)

**1.** Download or copy [exmaple-js-formatter-eslint-1](https://github.com/semiromid/live-alert-bp/tree/master/documentation/examples/gulp/js-formatter-eslint-1)
